...
public class LongOpt extends Object {
    ...
    /**
     * The value to store in "flag" if flag is not null, otherwise the equivalent
     ...
     * @param has_arg Indicates whether the option has no argument (NO_ARGUMENT), a
     ...
     *                                     NO_ARGUMENT, REQUIRED_ARGUMENT or
     *                                     OPTIONAL_ARGUMENT.
     */
